        ...
        for ii in range(1):
            for sample_id in self.sample_id_list:
                ...
                if self.crop_size > 100:
                    ...
                    ww_beg = np.random.randint(0, W - self.crop_size*8-shift_-1)
                    gt_patch_1 = gt_full_size_image[:, hh_beg+shift_:hh_beg+shift_ + self.crop_size,\
                                                     ww_beg+shift_:ww_beg+shift_+self.crop_size*8]
                    gt_patch_2 = gt_full_size_image[:, hh_beg:hh_beg + self.crop_size, ww_beg:ww_beg+self.crop_size*8]
